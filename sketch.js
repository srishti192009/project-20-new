...
function preload() {
  img1 = loadImage("images/audi (1).png");
  img2 = loadImage("images/lambo.png");
  img3 = loadImage("images/innova (1).png");
  img4 = loadImage("images/nano.png");
  c1red = loadImage("images/audi(red).png");
  c1yellow = loadImage("images/audi(yellow).png");
  c1green = loadImage("images/audi(green).png");
  c2red = loadImage("images/lambo(red).png");
  c2yellow = loadImage("images/lambo(yellow).png");
  c2green = loadImage("images/lambo(green).png");
  c3red = loadImage("images/innova(red).png");
  c3green = loadImage("images/innova(green).png");
  c4red = loadImage("images/innova(red).png");
  c4green=loadImage("images/innova(green).png");
  c3green = loadImage("images/innova(green).png");
  wImg = loadImage("images/Wall2.png");
}
